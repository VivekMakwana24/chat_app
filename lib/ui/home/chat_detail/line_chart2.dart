...
class LineChartSample1State extends State<LineChartSample1> {
  ...
  void initState() {
    super.initState();
    graphDataList?.addAll(_generateList());
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: _LineChart(graphDataList!, isShowingMainData),
                  ),
                ),
                const SizedBox(
                  height: 10,
  ...
  List<GraphData> _generateList() {
    return List.generate(
      ...
      (index) => GraphData(
        ...
        source: '0',
        device: '1',
        sensorId: '0013A200419F78A5_27TEMP',
        type: (index % 3 == 0) ? 'temp' : 'celcius',
...
class _LineChart extends StatefulWidget {
  ...
  _LineChart(this.graphDataList, this.isShowingMainData, {Key? key}) : super(key: key);
